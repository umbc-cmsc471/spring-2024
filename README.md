...
| Wed <br> Mar 6 | Stochastic Minimax <br>[Slides](assets/471-06-games-2.pdf) | [A comprehensive guide to MCTS algorithm with working example](https://youtu.be/UXW2yZndl7U?feature=shared) | RN 5.4,5.5,5.7  
| **Week 7** | | | | 
