...
| **Week 2** | | | |
| Mon <br> Feb 5 | Problem solving as search <br>[Slides.v2](assets/471-03-search-01.v2.pdf) | **HW1 is released on BB** | RN 3.1-3.3 
| Wed <br> Feb 7 | Uninformed search <br>[Slides](assets/471-03-search-02.pdf) // [Recording](https://umbc.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=bd517131-4117-4ee5-bad2-b10e0018d5ef) |  | RN 3.4                          <!-- Class# 4 -->
| **Week 3** | | | |    
